				...
				<div className="container">
					...
					<div className="row">
						...
						<div className="col-lg-6 offset-lg-1 ps-lg-0 pe-lg-5 mt-lg-0 mt-6">
							<h5 className="ds-5">Where Your IT Challenges Meet Innovative Solutions</h5>
							<p className="fs-5 text-500">Empower your team with expert IT consulting and tailored technological strategies.</p>
							<div className="d-md-flex align-items-center mt-4 mb-5">
								<ul className="list-unstyled phase-items mb-0">
									<li className="d-flex align-items-center mt-3">
										<img src="/assets/imgs/cta-2/check.svg" alt="infinia" />
										<span className="ms-2 text-900 fw-medium fs-6">Best For IT services & solutions</span>
									</li>
									<li className="d-flex align-items-center mt-3">
										<img src="/assets/imgs/cta-2/check.svg" alt="infinia" />
